...
- 喜欢直接说结论，不需要铺垫
- 对安全性很在意（建立了完整的 AI_RULES.md 规则体系）
- 不喜欢直接照搬现成代码，倾向于 AI 原创编写
- 愿意让 AI 自主决策，但破坏性操作需确认
...
- 日常对话：Qwen-Max / Step-2
- 推理任务：QwQ-32B / DeepSeek-R1
- 快速任务：Qwen-Turbo / Step-1

## 规则遵守

必须在每次会话开始时读取并遵守：`AI_RULES.md`（工作目录根目录）
